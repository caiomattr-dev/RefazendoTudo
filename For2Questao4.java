...
public class For2Questao4 {
	...
	public static void main(String[] args) {
		...
		if(mediasExemplares / 4 > 9.5) {
			System.out.println("As médias foram exemplares, acima de 9,5.");
		}
		else
			System.out.println("As médias foram excelentes, ficaram entre 9 e 9,5.");
